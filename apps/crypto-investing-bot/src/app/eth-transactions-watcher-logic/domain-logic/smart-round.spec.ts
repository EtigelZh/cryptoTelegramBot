...
describe('smartRound', () => {
  ...
  test('handles small fractions', () => {
    expect(smartRound(0.1)).toBe('0.1');
    expect(smartRound(0.111)).toBe('0.111');
    expect(smartRound(0.0012)).toBe('0.0012');
    expect(smartRound(0.001234)).toBe('0.001234');
    expect(smartRound(0.123123)).toBe('0.1231');
    expect(smartRound(0.562148042210)).toBe('0.5621');
    expect(smartRound(0.00012321)).toBe('0.0001232');
    expect(smartRound(0.000000000001)).toBe('0.000000000001');
    expect(smartRound(0.000000000001221231)).toBe('0.000000000001221');
    expect(smartRound(0.000000000001255631)).toBe('0.000000000001256');
  });
