...
export class Migrations1714453902690 implements MigrationInterface {
    name = 'Migrations1714453902690'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."transactions_transaction_type_enum" AS ENUM('send', 'receive', 'execute', 'trade', 'approve', 'withdraw', 'unknown')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."transactions_transaction_type_enum_old" AS ENUM('send', 'receive', 'execute', 'trade', 'approve', 'unknown')`);
